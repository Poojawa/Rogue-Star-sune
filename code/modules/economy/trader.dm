...
/obj/trader/general
	...
	start_products = list(
		...
		/obj/item/clothing/under/hyperfiber/bluespace/skirt = 25, // RS Edit - bluespace jumpskirts
	...
	prices = list(
		...
		/obj/item/clothing/under/hyperfiber/bluespace/skirt = 10, // RS Edit - bluespace jumpskirts
	...
	multiple = list(
		...
		/obj/item/clothing/under/hyperfiber/bluespace/skirt = 2, // RS Edit - bluespace jumpskirts
