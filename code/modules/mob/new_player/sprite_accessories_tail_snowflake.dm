...
/datum/sprite_accessory/tail/molenar_deathclaw
	...
	do_colouration = FALSE
	tailsock = "molenar-deathclawsock"
...
/datum/sprite_accessory/tail/featherfluff_tail
    ...
    ckeys_allowed = list("tucker0666")
    do_colouration = FALSE
    tailsock = "featherfluff_tailsock"
...
/datum/sprite_accessory/tail/longtail/long_lizard/roiz //Not a Taur, so be YEETED from tauric pathing, nerd.
	...
	tailsock = "lizardlongtail_s"

/datum/sprite_accessory/tail/peacocktail/red //this is ckey locked for now, but prettiebyrd wants these tails to be unlocked at a later date
